    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-islamic-dark mb-4">
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <div className="text-gray-500 text-xs mt-1">{goal.days}</div>
                  </div>
                </div>
              </button>
            ))}
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-8">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                ...
                <div className="font-semibold text-lg">{selectedGoal}x</div>
                <div className="text-sm text-gray-600">Completions</div>
              </div>
              <div>
                <Calendar className="w-8 h-8 text-islamic-green mx-auto mb-2" />
                <div className="font-semibold text-lg">{selectedGoal} Juz</div>
                <div className="text-sm text-gray-600">Per Day</div>
              </div>
              <div>
                <Book className="w-8 h-8 text-islamic-green mx-auto mb-2" />
                <div className="font-semibold text-lg">{30 * selectedGoal}</div>
                <div className="text-sm text-gray-600">Total Juz</div>
              </div>
            </div>
          </div>
