...
export default function Home() {
  ...
  const renderNavigationBar = () => {
    if (currentView === 'reader') {
      return (
        <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-white rounded-full shadow-lg px-6 py-3 flex items-center space-x-4 z-50 border border-islamic-green/20">
          <button
  ...
  return renderDashboardWithContinue()
}
